  ...
  return (
    <section className='day-sect'>
      <div className='day-card'>
       <img alt="forecast-icon" className='day-image' src={currentWeather.forecast.simpleforecast.forecastday[0].icon_url}/>
      ...
      <div className='day-card'>
        <img alt="forecast-icon" src={currentWeather.forecast.simpleforecast.forecastday[1].icon_url}/>
      ...
      <div className='day-card'>
        <img alt="forecast-icon" src={currentWeather.forecast.simpleforecast.forecastday[2].icon_url}/>
      ...
      <div className='day-card'>
       <img alt="forecast-icon" src={currentWeather.forecast.simpleforecast.forecastday[3].icon_url}/>
      ...
      <div className='day-card'>
       <img alt="forecast-icon" src={currentWeather.forecast.simpleforecast.forecastday[4].icon_url}/>
      ...
      <div className='day-card'>
       <img alt="forecast-icon" src={currentWeather.forecast.simpleforecast.forecastday[5].icon_url}/>
      ...
      <div className='day-card'>
       <img alt="forecast-icon" src={currentWeather.forecast.simpleforecast.forecastday[6].icon_url}/>
      ...
      <div className='day-card'>
        <img alt="forecast-icon" src={currentWeather.forecast.simpleforecast.forecastday[7].icon_url}/>
      ...
      <div className='day-card'>
        <img alt="forecast-icon" src={currentWeather.forecast.simpleforecast.forecastday[8].icon_url}/>
      ...
      <div className='day-card'>
         <img alt="forecast-icon" src={currentWeather.forecast.simpleforecast.forecastday[9].icon_url}/>
