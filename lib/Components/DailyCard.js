    ...
    <section className='day-sect'>
      <div className='day-card'>
       <img className='day-image' src={currentWeather.forecast.simpleforecast.forecastday[0].icon_url}/>
        ...
        <p className='daily-high-low'>{currentWeather.forecast.simpleforecast.forecastday[0].high.fahrenheit} °F/{currentWeather.forecast.simpleforecast.forecastday[0].low.fahrenheit} °F</p>
      </div>
